            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-25">
                        ...
                        {cartItems.map((item) => (
                            <p><a href="#">{item.title}</a> <span class="price">{item.qty}*{item.price}đ</span></p>
                        ))}
                        <hr/>
                        <p>Shipping <span class="price" style={{color: "black"}}><b>{shippingPrice}đ</b></span></p>
                        <p>Tax 10% <span class="price" style={{color: "black"}}><b>{taxPrice}đ</b></span></p>
                        <p>Total <span class="price" style={{color: "black"}}><b>{totalPrice}đ</b></span></p>
                        </div>
                    </div>
                    </div>
                </div>   
